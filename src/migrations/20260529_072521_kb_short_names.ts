...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_hero_block\` (
  	...
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`title\` text DEFAULT 'Discover Exceptional Properties in Greece.',
  	\`button_text\` text DEFAULT 'View All Properties',
  ...
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_block_background_image_idx\` ON \`pages_blocks_hero_block\` (\`background_image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_stats_block_stats\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`value\` text,
  	\`label\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_stats_block\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_stats_block_stats_order_idx\` ON \`pages_blocks_stats_block_stats\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_stats_block_stats_parent_id_idx\` ON \`pages_blocks_stats_block_stats\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_stats_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_stats_block_order_idx\` ON \`pages_blocks_stats_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_stats_block_parent_id_idx\` ON \`pages_blocks_stats_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_stats_block_path_idx\` ON \`pages_blocks_stats_block\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_mission_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_mission_block_order_idx\` ON \`pages_blocks_mission_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_mission_block_parent_id_idx\` ON \`pages_blocks_mission_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_mission_block_path_idx\` ON \`pages_blocks_mission_block\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_mission_block_image_idx\` ON \`pages_blocks_mission_block\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_properties_block_properties\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  	\`is_new_listing\` integer DEFAULT false,
  	\`location\` text,
  	\`title\` text,
  	\`beds\` numeric,
  	\`baths\` numeric,
  	...
  	\`price\` text,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_properties_block\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_properties_block_properties_order_idx\` ON \`pages_blocks_properties_block_properties\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_properties_block_properties_parent_id_idx\` ON \`pages_blocks_properties_block_properties\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_properties_block_properties_image_idx\` ON \`pages_blocks_properties_block_properties\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_properties_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_properties_block_order_idx\` ON \`pages_blocks_properties_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_properties_block_parent_id_idx\` ON \`pages_blocks_properties_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_properties_block_path_idx\` ON \`pages_blocks_properties_block\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_interactive_map_block_locations\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_interactive_map_block\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_interactive_map_block_locations_order_idx\` ON \`pages_blocks_interactive_map_block_locations\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_interactive_map_block_locations_parent_id_idx\` ON \`pages_blocks_interactive_map_block_locations\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_interactive_map_block_offices\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`name\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_interactive_map_block_offices_order_idx\` ON \`pages_blocks_interactive_map_block_offices\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_interactive_map_block_offices_parent_id_idx\` ON \`pages_blocks_interactive_map_block_offices\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_interactive_map_block_pins\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	...
  	\`title\` text,
  	\`subtitle\` text,
  	\`is_pulsing\` integer DEFAULT false,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_interactive_map_block\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_interactive_map_block_pins_order_idx\` ON \`pages_blocks_interactive_map_block_pins\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_interactive_map_block_pins_parent_id_idx\` ON \`pages_blocks_interactive_map_block_pins\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_interactive_map_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_interactive_map_block_order_idx\` ON \`pages_blocks_interactive_map_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_interactive_map_block_parent_id_idx\` ON \`pages_blocks_interactive_map_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_interactive_map_block_path_idx\` ON \`pages_blocks_interactive_map_block\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_interactive_map_block_map_image_idx\` ON \`pages_blocks_interactive_map_block\` (\`map_image_id\`);`)
  await db.run(sql`CREATE TABLE \`vtour\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`title\` text DEFAULT 'Step Inside Your Future Home from Anywhere in the World.',
  ...
  `)
  await db.run(sql`CREATE INDEX \`vtour_order_idx\` ON \`vtour\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`vtour_parent_id_idx\` ON \`vtour\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`vtour_path_idx\` ON \`vtour\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`vtour_background_image_idx\` ON \`vtour\` (\`background_image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_advisors_block_advisors\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  	...
  	\`role\` text,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_advisors_block\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_advisors_block_advisors_order_idx\` ON \`pages_blocks_advisors_block_advisors\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_advisors_block_advisors_parent_id_idx\` ON \`pages_blocks_advisors_block_advisors\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_advisors_block_advisors_image_idx\` ON \`pages_blocks_advisors_block_advisors\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_advisors_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`subtitle\` text DEFAULT 'MEET OUR TEAM',
  	\`title\` text DEFAULT 'Meet Our Distinguished Agents',
  	\`block_name\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_advisors_block_order_idx\` ON \`pages_blocks_advisors_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_advisors_block_parent_id_idx\` ON \`pages_blocks_advisors_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_advisors_block_path_idx\` ON \`pages_blocks_advisors_block\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`arts\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  	...
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`kb\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`arts_order_idx\` ON \`arts\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`arts_parent_id_idx\` ON \`arts\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`arts_image_idx\` ON \`arts\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`kb\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`subtitle\` text DEFAULT 'KNOWLEDGE BASE',
  	\`title\` text DEFAULT 'Latest News',
  	\`populate_by\` text DEFAULT 'collection',
  ...
  `)
  await db.run(sql`CREATE INDEX \`kb_order_idx\` ON \`kb\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`kb_parent_id_idx\` ON \`kb\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`kb_path_idx\` ON \`kb\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`dual\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`assign_panel_title\` text,
  	\`assign_panel_description\` text,
  	\`assign_panel_button_text\` text,
  	\`assign_panel_panel_link_type\` text DEFAULT 'reference',
  	\`assign_panel_panel_link_new_tab\` integer,
  	\`assign_panel_panel_link_url\` text,
  	\`assign_panel_panel_link_label\` text,
  	\`search_panel_title\` text,
  	\`search_panel_description\` text,
  	\`search_panel_button_text\` text,
  	\`search_panel_panel_link_type\` text DEFAULT 'reference',
  	\`search_panel_panel_link_new_tab\` integer,
  	\`search_panel_panel_link_url\` text,
  	\`search_panel_panel_link_label\` text,
  	\`block_name\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`dual_order_idx\` ON \`dual\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`dual_parent_id_idx\` ON \`dual\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`dual_path_idx\` ON \`dual\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_block_background_image_idx\` ON \`_pages_v_blocks_hero_block\` (\`background_image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_stats_block_stats\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`value\` text,
  	\`label\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_stats_block\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_stats_block_stats_order_idx\` ON \`_pages_v_blocks_stats_block_stats\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_stats_block_stats_parent_id_idx\` ON \`_pages_v_blocks_stats_block_stats\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_stats_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_stats_block_order_idx\` ON \`_pages_v_blocks_stats_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_stats_block_parent_id_idx\` ON \`_pages_v_blocks_stats_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_stats_block_path_idx\` ON \`_pages_v_blocks_stats_block\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_mission_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_mission_block_order_idx\` ON \`_pages_v_blocks_mission_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_mission_block_parent_id_idx\` ON \`_pages_v_blocks_mission_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_mission_block_path_idx\` ON \`_pages_v_blocks_mission_block\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_mission_block_image_idx\` ON \`_pages_v_blocks_mission_block\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_properties_block_properties\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  	...
  	\`_uuid\` text,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_properties_block\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_properties_block_properties_order_idx\` ON \`_pages_v_blocks_properties_block_properties\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_properties_block_properties_parent_id_idx\` ON \`_pages_v_blocks_properties_block_properties\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_properties_block_properties_image_idx\` ON \`_pages_v_blocks_properties_block_properties\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_properties_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_properties_block_order_idx\` ON \`_pages_v_blocks_properties_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_properties_block_parent_id_idx\` ON \`_pages_v_blocks_properties_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_properties_block_path_idx\` ON \`_pages_v_blocks_properties_block\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_interactive_map_block_locations\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`label\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_interactive_map_block\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_interactive_map_block_locations_order_idx\` ON \`_pages_v_blocks_interactive_map_block_locations\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_interactive_map_block_locations_parent_id_idx\` ON \`_pages_v_blocks_interactive_map_block_locations\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_interactive_map_block_offices\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`name\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_interactive_map_block_offices_order_idx\` ON \`_pages_v_blocks_interactive_map_block_offices\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_interactive_map_block_offices_parent_id_idx\` ON \`_pages_v_blocks_interactive_map_block_offices\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_interactive_map_block_pins\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`top_percentage\` numeric,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_interactive_map_block_pins_order_idx\` ON \`_pages_v_blocks_interactive_map_block_pins\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_interactive_map_block_pins_parent_id_idx\` ON \`_pages_v_blocks_interactive_map_block_pins\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_interactive_map_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_interactive_map_block_order_idx\` ON \`_pages_v_blocks_interactive_map_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_interactive_map_block_parent_id_idx\` ON \`_pages_v_blocks_interactive_map_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_interactive_map_block_path_idx\` ON \`_pages_v_blocks_interactive_map_block\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_interactive_map_block_map_image_idx\` ON \`_pages_v_blocks_interactive_map_block\` (\`map_image_id\`);`)
  await db.run(sql`CREATE TABLE \`_vtour_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_vtour_v_order_idx\` ON \`_vtour_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_vtour_v_parent_id_idx\` ON \`_vtour_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_vtour_v_path_idx\` ON \`_vtour_v\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_vtour_v_background_image_idx\` ON \`_vtour_v\` (\`background_image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_advisors_block_advisors\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  	...
  	\`_uuid\` text,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_advisors_block\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_advisors_block_advisors_order_idx\` ON \`_pages_v_blocks_advisors_block_advisors\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_advisors_block_advisors_parent_id_idx\` ON \`_pages_v_blocks_advisors_block_advisors\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_advisors_block_advisors_image_idx\` ON \`_pages_v_blocks_advisors_block_advisors\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_advisors_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_advisors_block_order_idx\` ON \`_pages_v_blocks_advisors_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_advisors_block_parent_id_idx\` ON \`_pages_v_blocks_advisors_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_advisors_block_path_idx\` ON \`_pages_v_blocks_advisors_block\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_testimonials_block_testimonials\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`quote\` text,
  	...
  	\`author_role\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_testimonials_block\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_testimonials_block_testimonials_order_idx\` ON \`_pages_v_blocks_testimonials_block_testimonials\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_testimonials_block_testimonials_parent_id_idx\` ON \`_pages_v_blocks_testimonials_block_testimonials\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_arts_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  	...
  	\`_uuid\` text,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_kb_v\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_arts_v_order_idx\` ON \`_arts_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_arts_v_parent_id_idx\` ON \`_arts_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_arts_v_image_idx\` ON \`_arts_v\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_kb_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_kb_v_order_idx\` ON \`_kb_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_kb_v_parent_id_idx\` ON \`_kb_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_kb_v_path_idx\` ON \`_kb_v\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_dual_v\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_dual_v_order_idx\` ON \`_dual_v\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_dual_v_parent_id_idx\` ON \`_dual_v\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_dual_v_path_idx\` ON \`_dual_v\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`theme\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`colors_primary\` text DEFAULT '#000000' NOT NULL,
  	\`colors_secondary\` text DEFAULT '#5e5e5c' NOT NULL,
  	\`colors_tertiary\` text DEFAULT '#755b00' NOT NULL,
  	\`colors_surface\` text DEFAULT '#fef9f1' NOT NULL,
  	\`colors_background\` text DEFAULT '#fef9f1' NOT NULL,
  	\`updated_at\` text,
  	\`created_at\` text
  );
  `)
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`pages_blocks_stats_block_stats\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_stats_block\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_mission_block\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_properties_block_properties\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_properties_block\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_interactive_map_block_locations\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_interactive_map_block_offices\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_interactive_map_block_pins\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_interactive_map_block\`;`)
  await db.run(sql`DROP TABLE \`vtour\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_advisors_block_advisors\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_advisors_block\`;`)
  ...
  await db.run(sql`DROP TABLE \`arts\`;`)
  await db.run(sql`DROP TABLE \`kb\`;`)
  await db.run(sql`DROP TABLE \`dual\`;`)
  ...
  await db.run(sql`DROP TABLE \`_pages_v_blocks_stats_block_stats\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_stats_block\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_mission_block\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_properties_block_properties\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_properties_block\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_interactive_map_block_locations\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_interactive_map_block_offices\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_interactive_map_block_pins\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_interactive_map_block\`;`)
  await db.run(sql`DROP TABLE \`_vtour_v\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_advisors_block_advisors\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_advisors_block\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_testimonials_block_testimonials\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_testimonials_block\`;`)
  await db.run(sql`DROP TABLE \`_arts_v\`;`)
  await db.run(sql`DROP TABLE \`_kb_v\`;`)
  await db.run(sql`DROP TABLE \`_dual_v\`;`)
