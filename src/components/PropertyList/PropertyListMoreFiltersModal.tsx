...
const modalInputClass =
  'w-full bg-surface-container-low border-transparent focus:border-tertiary focus:ring-0 rounded-lg py-3 px-4 font-body-md text-body-md text-on-surface'
...
}> = ({ label, value, options, onChange, menuPlacement }) => (
  <FilterSelect
    label={label}
    options={options}
    value={value}
